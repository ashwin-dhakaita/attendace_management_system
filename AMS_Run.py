...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec_delete, fg="black", bg="white", width=9, height=1, activebackground="gray",
        ...
        if subb=='':
            ...
            def err_screen1():
                ...
                Button(errsc2, text='OK', command=del_errsc2, fg="black", bg="white", width=9, height=1,
                       activebackground="gray", font=('times', 15, ' bold ')).place(x=90, y=50)
...
def err_screen():
    ...
    Button(sc1,text='OK',command=del_sc1,fg="black"  ,bg="white"  ,width=9  ,height=1, activebackground = "gray" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def err_screen1():
    ...
    Button(sc2,text='OK',command=del_sc2,fg="black"  ,bg="white"  ,width=9  ,height=1, activebackground = "gray" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            Notification.configure(text=res, bg="gray", width=50, font=('times', 18, 'bold'))
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                Notifica.configure(text=M, bg="white", fg="black", width=33, font=('times', 15, 'bold'))
                Notifica.place(x=20, y=250)
...
def admin_panel():
    ...
    un_entr = tk.Entry(win, width=20, bg="light gray", fg="black", font=('times', 23, ' bold '))
    un_entr.place(x=290, y=55)

    def c11():
        pw_entr.delete(first=0, last=22)

    pw_entr = tk.Entry(win, width=20,show="*", bg="light gray", fg="black", font=('times', 23, ' bold '))
...
def trainimg():
    ...
    try:
        ...
        Notification.configure(text=l, bg="gray", width=50, font=('times', 18, 'bold'))
    ...
    try:
        ...
        Notification.configure(text=q, bg="gray", width=50, font=('times', 18, 'bold'))
        Notification.place(x=350, y=400)
...
message = tk.Label(window, text="Attendance-Management-System", bg="white", fg="black", width=50,
...
txt = tk.Entry(window, validate="key", width=20, bg="light gray", fg="black", font=('times', 25, ' bold '))
...
txt2 = tk.Entry(window, width=20, bg="light gray", fg="black", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

clearButton = tk.Button(window, text="Clear",command=clear,fg="black"  ,bg="white"  ,width=10  ,height=1 ,activebackground = "gray" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="white"  ,width=10 ,height=1, activebackground = "gray" ,font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Register students",command=admin_panel,fg="black"  ,bg="white"  ,width=19 ,height=1, activebackground = "gray" ,font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="black"  ,bg="white"  ,width=20  ,height=3, activebackground = "gray" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="white"  ,width=20  ,height=3, activebackground = "gray" ,font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance",fg="black",command=subjectchoose  ,bg="white"  ,width=20  ,height=3, activebackground = "gray" ,font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill  ,fg="black"  ,bg="white"  ,width=20  ,height=3, activebackground = "gray" ,font=('times', 15, ' bold '))
